...
def postprocess_iffs(root_dir:str, data_path:str, tag:str, mask_tag:str, Npix:int, D:float, r0=0.03, L0=25):
    ...
    ifunc_obj = IFunc(
        ifunc=IF,
        mask=(1-bin_pup_mask).astype(specula.xp.uint8)
    )
    ...
    pupil_mask = Pupilstop(simul_params=simul_params, input_mask=1-bin_pup_mask)
...
if __name__ == "__main__":
    ...
    postprocess_iffs(root_dir=root_dir, data_path=data_path, mask_tag='copernico_pupil_120pixels', tag='DM468', Npix=120, D=D)
