...
pupids = fits.getdata('/raid1/mmenessini/calibration/SOUL/KLv32sx/pupils/pup_ids.fits')
...
def generate_rec(im,Nmodes:int,argos:bool,rMod=3.0): 
    rec_hdr = fits.getheader('/raid1/mmenessini/calibration/SOUL/KLv32sx/data/Rec_20250509_183420.fits').copy()
