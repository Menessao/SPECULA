...
zwfs_config = 'ristretto_unobs_zwfs.yml' #'ristretto_main.yml'
root_dir='/raid1/mmenessini/calibration/RISTRETTOunobs'


# # Z1. Calibrate IM vs n_subaps, rMods
...
#         zwfs_tag = f'z2wfs_{dotDelay:1.2f}delay_{n_subap:.0f}x{n_subap:.0f}'
...
#         try:
#             os.system(f"specula {zwfs_config} calib_im_zwfs.yml temp_overrides.yml")
...
#                             f"data_store.store_dir:         {os.path.join(root_dir,'scratch_aliasing')}, "  
#                             f"data_store.create_tn: false, "
#                             f"data_store.inputs.input_list: ['pyr_frames-cred1.out_pixels', 'pyr_modes-pyr_modalrec.out_modes', 'slopes-pyr_slopes.out_slopes'], "
#                             "}")
#                 write_yaml_overrides(input_string=overrides)
...
#             for N in mode_vec:
#                 tag = f'pyr{rMod:1.1f}_{n_subap:.0f}x{n_subap:.0f}_s{seeing:1.2f}_{N:1.0f}modes'
#                 simpc_tag = tag+f'_{res:1.0f}Nm_simpc'
#                 overrides = ("{"
#                             f"main.total_time: {N*2*ncycles/fs}, "
#                             f"atmo_random.update_interval: {N*2:1.0f}, "
#                             f"pyr.pup_diam: {n_subap:.1f}, "
...
#                             f"scale_random.constant_mul_data: 'cvec_s{seeing:1.2f}_{N}modes_{res:1.0f}Nm', "
